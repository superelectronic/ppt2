...
> XML has its own universe. This session does not intend to tell you everything about XML.
...
> Example, <name>John Doe</name> or <age>25</age> or <isenabled>false</isenabled>
